...
// export type SwapPayload = { fromAsset: string; toAsset: string; fromAmount: number };
// export type FundingPayload = { type: FundingType; asset: string; amount: number };
// export type LoginPayload = { email: string; password: string };
// export type RegisterPayload = { email: string; password: string; username?: string };
// export type OfferPayload = { type: 'buy' | 'sell'; asset: string; price: number };
